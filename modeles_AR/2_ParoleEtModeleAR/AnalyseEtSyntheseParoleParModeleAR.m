...
% Chargement de la donn�e de parole dans y
%load('DataParole.mat')
%z = DataParole;
...
% Ecoute de la donn�e de parole 
soundsc(z)

% Visualisation de la donn�e de parole 
figure
plot(z);
title('Donn�es de parole');
pause
...
hold off
title('Syntheses');
legend('Synth�se par BBG', 'Synth�se par Erreur-residuelle');
...
pause
%%%%%%
soundsc(residuel) % parole estim�e
pause  
%%%%%%
soundsc(Synth3) % parole synth�tis�e avec l'erreur d'estimation
pause
%%%%%%
soundsc(Synth2) % parole synth�tis�e avec bruit blanc gaussien
